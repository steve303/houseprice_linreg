...
if i were to make a sweeping statement about trying to interpret this model, there seems to be a lot of interactions tied to the bedroom, bathroom and sqftliving.  How's that for our interpetation?  of course zip code by itself is important, most are significant.  we should put this long summary in the appendix.  I thought we should not bother with the log transform price models as our chosen model for simiplicity but it's up to you. 
```{r}
summary(poly_int_aic)
