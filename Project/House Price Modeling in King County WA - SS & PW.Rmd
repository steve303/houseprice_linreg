...
## Methods
First, we load the data stored in [`kc_house_data.csv`](`kc_house_data.csv`) for the values of the predictors and the response. Immediately, we split this into a training data set (80%) and a testing data set (20%).
